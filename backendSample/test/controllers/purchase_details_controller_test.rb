...
class PurchaseDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create purchase_detail" do
    assert_difference('PurchaseDetail.count') do
      post purchase_details_url, params: { purchase_detail: { product_id: @purchase_detail.product_id, purchase_id: @purchase_detail.purchase_id, quantity: @purchase_detail.quantity } }
    end
  ...
  test "should update purchase_detail" do
    patch purchase_detail_url(@purchase_detail), params: { purchase_detail: { product_id: @purchase_detail.product_id, purchase_id: @purchase_detail.purchase_id, quantity: @purchase_detail.quantity } }
